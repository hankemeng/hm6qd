...
%type <stmt> StmtBlock Stmt IfStmt WhileStmt ForStmt ReturnStmt BreakStmt PrintStmt 
%type <stmtList> StmtList
%type <expr> Expr ExprEmpty LValue Call Constant
%type <exprList> ExprList Actuals
%type <extends> Extends
%type <implements> Implements IdentList
...
Implements: T_Implements IdentList  { $$ = $2; }
| /*empty*/                         { $$ = NULL; }//??
;
...
ForStmt: T_For '(' ExprEmpty ';' Expr ';' ExprEmpty ')' Stmt
                                    { $$ = new ForStmt($3, $5, $7, $9); }
;
...
ReturnStmt: T_Return ExprEmpty ';'  { $$ = new ReturnStmt(@1, $2); }
;
...
| Expr '<' '=' Expr                 { $$ = new RelationalExpr($1, new Operator(@2, "<="), $4); }
| Expr '>' Expr                     { $$ = new RelationalExpr($1, new Operator(@2, ">"), $3); }
| Expr '>' '=' Expr                 { $$ = new RelationalExpr($1, new Operator(@2, ">="), $4); }
| Expr '=' '=' Expr                 { $$ = new EqualityExpr($1, new Operator(@2, "=="), $4); }
| Expr '!' '=' Expr                 { $$ = new EqualityExpr($1, new Operator(@2, "!="), $4); }
| Expr '&' '&' Expr                 { $$ = new LogicalExpr($1, new Operator(@2, "&&"), $4); }
| Expr '|' '|' Expr                 { $$ = new LogicalExpr($1, new Operator(@2, "||"), $4); }
